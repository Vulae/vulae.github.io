...
<style lang="scss">
    ...
    .social-link {
        @apply flex items-center justify-evenly gap-4 px-8 py-2 drop-shadow-sm transition-all text-white;
...
<div class="z-10 flex flex-wrap items-center justify-center gap-16 p-8 max-w-full max-h-full">
    ...
    >
        ...
        <span class="flex justify-center w-full border-b-2 border-white pb-2">Links</span>
